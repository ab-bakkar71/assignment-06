...
const Pricing = () => {
    return (
        <>
            <div className='max-w-300 mx-auto w-[90%] text-center space-y-2 py-30'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                    ...
                    <div className="card w-96 bg-base-100 shadow-sm bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white">
                        <div className="card-body relative">
                            ...
                            <div class="absolute -top-3 left-35 badge badge-warning border-0 bg-amber-100 text-amber-500 ">Most Popular</div>
                        </div>
                    </div>
                    {/* card 3 */}
                    <div className="card w-96 bg-base-100 shadow-sm">
